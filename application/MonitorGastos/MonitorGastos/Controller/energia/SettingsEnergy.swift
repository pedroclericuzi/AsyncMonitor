...
class SettingsEnergy: UIViewController {
    ...
    @IBAction func Save(_ sender: Any) {
        //firebasedb.salvarDefinicoesEnergia()
        self.ref.child("energia/definicoes/dia").setValue(Int(diaProxLeitura.text!))
        self.ref.child("energia/definicoes/mes").setValue(Int(mesProxLeitura.text!))
        self.ref.child("energia/definicoes/meta").setValue(Int(meta.text!))
